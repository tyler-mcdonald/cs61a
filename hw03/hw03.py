...
def count_coins(change):
    ...
    def count(total, smallest_coin):
        # 0 ways to make change for 0 cents
        if total == 0:
            return 1
        # 0 ways to make change for negative cents
        elif total < 0:
            return 0
        elif smallest_coin == None:
            return 0
        else:
            without_coin = count(total, next_larger_coin(smallest_coin))
            with_coin = count(total - smallest_coin, smallest_coin)
